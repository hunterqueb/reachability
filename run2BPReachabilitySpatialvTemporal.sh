...
python scripts/reachability2BP_TC.py --train-ratio 0.8 --model mamba --dv ${DV} --train-timesteps 5 --lookback 4 --pdf
...
python scripts/reachability2BP_TC.py --train-ratio 0.8 --model mamba --dv ${DV} --train-timesteps 10 --lookback 4 --pdf
