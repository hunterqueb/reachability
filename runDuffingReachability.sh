...
python scripts/reachabilityDuffing.py --train-ratio 0.2 --model mamba --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.8 --model mamba --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.2 --model mamba --ood --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.8 --model mamba --ood --dv ${DV}

python scripts/reachabilityDuffing.py --train-ratio 0.2 --model lstm --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.8 --model lstm --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.2 --model lstm --ood --dv ${DV}
python scripts/reachabilityDuffing.py --train-ratio 0.8 --model lstm --ood --dv ${DV}