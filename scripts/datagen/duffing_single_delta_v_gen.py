...
if __name__ == "__main__":
    ...
    save_dir = "./data/test/"
    save_file = f"duffing_single_monte_carlo_trajectories_dv_{delta_v_radius}_dt_{args.dt}_n_{args.n}.npz"
    ...
    x0_mean = [0.2, 0.0]
    x0_box_radius = [0, 0] # no initial condition uncertainty, only deltaV uncertainty
    ...
    if args.ood:
        ...
        x0_box_radius_ood = [0, 0]  # increase initial condition uncertainty for OOD
